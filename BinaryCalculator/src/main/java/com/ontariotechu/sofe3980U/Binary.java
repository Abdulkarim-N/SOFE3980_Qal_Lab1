...
public class Binary
{
	...
	public static Binary binaryOR(Binary num1, Binary num2){
		...
		Binary result = new Binary(num3.toString());
		return result;
	...
	public static Binary binaryMulti(Binary num1, Binary num2){
		int bnum1 = Integer.parseInt(num1.getValue(),2);
		Binary res = new Binary("0");
		for (int i = 1; i<= bnum1; i++){
			res = add(res,num2);
		}
		return res;
	}

	// creating a tostring method bcz it keeps outputting Their or is com.ontariotechu.sofe3980U.Binary@11028347 for some reason
